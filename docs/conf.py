...
html_logo = 'https://github.com/hgb-bin-proteomics/MSAnnika/raw/master/logo/icons/icon.png'
html_favicon = 'https://github.com/hgb-bin-proteomics/MSAnnika/raw/master/logo/icons/favicon.png'
